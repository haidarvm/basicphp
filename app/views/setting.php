                ...
                <div class="card px-1 py-1">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            echo '</div>
                                  <div class="d-grid gap-2 text-center mt-2 col-12 mx-auto">';
                            $form->button('submit',"Save", 'btn btn-danger btn-lg',1);
                            echo '</div>';
                            $form->close();
                            $form->open('', "needs-validation form2");
                            echo '<h5 class="mb-3 fw-bold text-center mt-2"><i class="fa-solid fa-wifi fa-xs text-danger me-2"></i> GPRS</h5>
                            <hr class=""/><div class="row g-3">';
                            ...
                            echo '</div>
                                  <div class="d-flex flex-column text-center px-5 mt-3 mb-3"> <small class="agree-text">By Changing setting you  agree to the changes and consequence of any erros</small> <a href="#" class="terms">Terms & Conditions</a></div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row g-3">
                                ...
                                echo '<div class="d-flex flex-column text-center px-5 mt-3 mb-3"> <small class="agree-text">By Changing setting you  agree to the changes and consequence of any erros</small> <a href="#" class="terms">Terms & Conditions</a></div>
                                       <hr  style="margin:0 10px;width:560px"/><div class="row mt-4">';
